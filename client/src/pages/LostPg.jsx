...
const LostPg = () => {
  ...
  const handleDelete = async () => {
    await deleteLostMessage(currentPlace, selectedMsgId);
    setView("lnf");
  };
      ...
      {showForm && view === "lnf" && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          <LnFForm
            ...
            onSuccess={() => getLostMessages(currentPlace)}
          />
        </div>
      )}
    </div>
